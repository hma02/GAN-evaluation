...
from layers.batch_norm_conv_layer_gran import BN_Conv_layer
from layers.batch_norm_layer_gran import Batch_Norm_layer
from layers.conv_layer_gran import Conv_layer
from layers.deconv_gran import Deconv_layer
from layers.utils import activation_fn_th
...
class RecGenI64(object):
    ...
    def get_samples(self, num_sam, scanF=True, num_steps=None):
        ...
        Zs = MRG.uniform(size=(self.num_steps, num_sam, self.dim_sample), low=-1., high=1.)
    ...
    def get_samples_old(self, num_sam, scanF=True):
        """
        Retrieves the samples for the current time step. 
        uncomment parts when time step changes.
        """
