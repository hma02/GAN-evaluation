...
class GenI32(object):
    ...
    def forward(self, Z, testF=False, atype='relu'):
        ...
        H4 = self.L4.deconv(H3, atype='sigmoid') #Sigmoid gets applied layer after the cumulation 
    ...
    def weight_decay_l2(self):
        ...
        return (self.L1.l2_norm() + self.L2.l2_norm() +\
                self.L3.l2_norm() + self.L4.l2_norm())
