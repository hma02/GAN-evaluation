...
class BN_Deconv_layer(object):
    ...
    def init_conv_filters(self, numpy_rng, D, poolsize):
        ...
        self.W = theano.shared(
                init_conv_weights(-W_bound, W_bound, self.filter_shape, \
                numpy_rng), borrow=True, name='W_conv')
    ...
    def deconv(self, X, subsample=(2, 2), border_mode=(2, 2), conv_mode='conv', atype='sigmoid', testF=False):
        """ 
