...
class AISPath:
    def __init__(self, generator, obs, num_samples, sigma, hdim, L, epsilon, data, prior, init_state=None):
...
def run_ais(model, obs, num_samples, num_steps, sigma, hdim, L, epsilon, data, prior, schedule=None,recog=None):
    if schedule is None:
